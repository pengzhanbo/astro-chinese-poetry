...
export function sourcePath(url: string) {
  return path.join(dirname, '../../raw-data', url)
}
export function targetPath(url: string) {
  return path.join(dirname, '../../src/database', url)
}
